...
class Bird extends GameObject {
    ...
    public Bird(int x, int y){
        ...
        tube[0] = new Tube(900, GameLauncher.HEIGHT - 60); // Create the first wall
    ...
    private void checkWindowBorder() { 
        if(this.x > GameLauncher.WIDTH) { // If the bird has moved off the right side of the screen
            this.x = GameLauncher.WIDTH; // Set the x position of the bird to the right side of the screen
        }
        ...
        if(this.y > GameLauncher.HEIGHT - 50) { // If the bird has moved off the bottom of the screen
            this.y = GameLauncher.HEIGHT - 50; // Set the y position of the bird to the bottom of the screen
        }
...
class Game extends JPanel implements ActionListener {
    ...
    public void paint(Graphics g) {
        ...
        if (isRunning) {
            ...
            g2.drawString("Press Enter to Start Game", GameLauncher.WIDTH / 2 - 350, GameLauncher.HEIGHT / 2);
            g2.setColor(Color.black);
            g.setFont(new Font("MV Boli", 1, 15));
        }
        g2.setColor(Color.black);
        g.setFont(new Font("MV Boli", 1, 30));
        g2.drawString("High Score: " + highScore, GameLauncher.WIDTH - 230, 50);
    ...
    private void restartGame() {
        if (!isRunning) {
            this.isRunning = true;
            this.bird = new Bird(GameLauncher.WIDTH / 2, GameLauncher.HEIGHT / 2); // Create the bird object in the middle of the screen 
...
public class GameLauncher {
    ...
    public GameLauncher(int width, int height, String title, Game game) {
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
        	GameLauncher window = new GameLauncher(WIDTH, HEIGHT, "Flappy Bird", game);
        });
    }
}